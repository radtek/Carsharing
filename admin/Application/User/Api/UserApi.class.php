...
class UserApi extends Api
{
     ...
     */
    public function appLogin($username, $password, $type = 1)
    {
        return $this->model->appLogin($username, $password, $type);
    }
     ...
     */
    public function appRegister($username, $password, $phone, $name, $gender)
    {
        return $this->model->appRegister($username, $password, $phone, $name, $gender);
    }
