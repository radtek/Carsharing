...
let Location2 = React.createClass({
    ...
    render()
    {
        ...
        let center = "121.425908,31.183765",// 中心经纬度
            radius = 10000,// 搜索半径(单位:米)
            keywords = "小区,车库", // 附近搜索分类
            key = "38dbfac589d262c87bd3aaba70038538";// 高德地图申请key值 608d75903d29ad471362f8c58c550daf
...
export default connect()(Location2);