...
import { myLineOfficeAddress } from '../../../actions/actions';
...
let MyLineOfficeMap = React.createClass({
    contextTypes: {
    ...
    searchClickOK()
    {
        ...
        iframe.postMessage('officeAddress', 'https://m.amap.com/picker/');
            ...
            [
                {text: '取消', onPress: () => console.log('cancel')},
                {
                    text: '确定', onPress: () => {
                        ...
                        dispatch(myLineOfficeAddress(data));
                        window.removeEventListener("message", this.getMSG);
                        this.context.router.goBack();
                    }
                }
...
MyLineOfficeMap = createForm()(MyLineOfficeMap);
export default connect()(MyLineOfficeMap);