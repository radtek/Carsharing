...
import { myLineHomeAddress } from '../../../actions/actions';
...
let MyLineHomeMap = React.createClass({
    contextTypes: {
            ...
            [
                {text: '取消', onPress: () => console.log('cancel')},
                {
                    text: '确定', onPress: () => {
                        ...
                        dispatch(myLineHomeAddress(data));
                        window.removeEventListener("message", this.getMSG);
                        this.context.router.goBack();
                    }
                }
...
MyLineHomeMap = createForm()(MyLineHomeMap);
export default connect()(MyLineHomeMap);