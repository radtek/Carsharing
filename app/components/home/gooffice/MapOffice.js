...
import { goOfficeOfficeAddress } from '../../../actions/actions';
...
let MapOffice = React.createClass({
    contextTypes: {
            ...
            [
                {text: '取消', onPress: () => console.log('cancel')},
                {
                    text: '确定', onPress: () => {
                        ...
                        dispatch(goOfficeOfficeAddress(data));
                        window.removeEventListener("message", this.getMSG);
                        this.context.router.goBack();
                    }
                }
...
MapOffice = createForm()(MapOffice);
export default connect()(MapOffice);