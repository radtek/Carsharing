...
import { travelFrom,travelTo } from '../../../actions/actions';
...
let CityTo = React.createClass({
    ...
    selectOneCity(data){
        ...
        dispatch(travelTo({address:data,location:"121.425908,31.183765",name:"city"}));

        this.context.router.push("travelout");
    }
});

CityTo = createForm()(CityTo);

export default connect()(CityTo);